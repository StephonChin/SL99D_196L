...
//transmit rule: (((24bit color + 1bit end) * LED_TOTAL) + 12bits guide)
#if AL99D
#define LED_TOTAL               196             
...
#define NUM_RGB_BYTES           735             
#define NUM_I2S_PIXEL_BYTES1    3000            
#define NUM_I2S_PIXEL_WORDS1    750             
#define NUM_I2S_PIXEL_BYTES2    3860           
#define NUM_I2S_PIXEL_WORDS2    965           

#endif

// -----------------------------------------------------
// I2S timing parameters 
#define WS_I2S_BCK          (36)                        // >=18
